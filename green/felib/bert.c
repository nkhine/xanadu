...
long hashoftumbler();
long primes[] =
	{3,7,11,17,37,41,59,71,97,103,113,131,151,137,277,421,433,567,643,743};
...
/* probably the worlds most inefficient hashing function  */
/* I'll fix it if gprof says I should, and not before */
