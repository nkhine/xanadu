  ...
  spantype *spanptr, **newptrptr;
{
  ...
  void	
copytumbleritemset (tumbleritemptr, newptrptr)
  tumbleritemtype *tumbleritemptr, **newptrptr;
{
  tumbleritemtype *last, *this;
  tumbleritemtype *tumbleritemalloc();

        *newptrptr = NULL;
        last = NULL;
        for (; tumbleritemptr; tumbleritemptr = tumbleritemptr->nexttumbleritem) {
                this = tumbleritemalloc ();
                movetumbler(&tumbleritemptr->value,&this->value);
                this->prevtumbleritem = last;
                last = this;
                *newptrptr = this;
                newptrptr = &this->nexttumbleritem;
        }
}
